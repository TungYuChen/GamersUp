  ...
  return (
    <>
      <div className='card bg-base-100 shadow-xl w-2/3 mt-3 mb-3 mx-auto'>
        <div className='card-body min-h-full flex items-center justify-center py-10 mx-auto'>
          <div className='space-y-3'>
              <h2 className='card-title text-center text-2xl font-extrabold text-neutral-content'>
                Profile
              </h2>
              <p className='text-sm text-gray-300'>
                Your profile information will be displayed publicly so be careful with what
                you share.
              </p>
            </div>
