...
@Service
public record ResetPasswordService(GamerService gamerService,
    ...
    public String resetPassword(ResetPasswordRequest request) {
        ...
        GamerInfo gamer = gamerService.getGamerByEmail(request.getEmail());
        String newPassword = generateRandomPassword();
        gamerService.updatePassword(gamer, newPassword);
